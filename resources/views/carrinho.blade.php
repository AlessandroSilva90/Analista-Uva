        ...
        @else
                ...
                @foreach ($pedidos as $pedido)
                    <li>
                        <x-modais.card titulo="{{ $pedido->produto->nome }}" descricao="{{ $pedido->produto->descricao }}"
                            ...
                            valor="{{ $pedido->produto->preco_venda }} " />
                @endforeach
                </li>
            </ul>
            ...
            <div class="container flex flex-row w-full">
                ...
                <div class="total w-full">
                    ...
                    <input type="text" value="{{ $total }}" disabled class="form-control text-black">
                    @if ($totalFinal)
                ...
                <div class="cupom w-full">
                    <form action="{{ route('cupom_desconto.store') }}" method="POST" class="pl-8  text-black">
                        @csrf
